...
namespace Exercise4
{
    ...
    public class ItineraryManager
    {
        ...
        public ItineraryManager()
        {
            ...
            _distanceCalculator =
                new GoogleMapsDistanceCalculator(ConfigurationManager.AppSettings["GoogleMapsApiKey"]);
        }
        ...
        public IEnumerable<Quote> CalculateAirlinePrices(int itineraryId,
            IEnumerable<IAirlinePriceProvider> priceProviders)
        {
